...
import com.divergent.schoolmanagementsystem.doa.ClassDao;
...
public class ClassCrud {
	...
	public void showClassMenu() {
		s_panel: while (true) {
			myLogger.info("\n************************Class CRUD************************\n");
			System.out.println("1:Class Create : ");
			System.out.println("2:Class Read : ");
			System.out.println("3:Class Update : ");
			System.out.println("4:Class Delete : ");
	...
	public void update() {
		...
		try {
			...
			String section = scanner.nextLine().trim().toLowerCase();
			System.out.println(" \nEnter Teacher Id ------- ");
			int teacherid = scanner.nextInt();
			classDao.update(id, name, section, teacherid);
	...
	public void create() {
		...
		try {
			...
			System.out.println(" \nEnter Teacher Id ------- ");
			int teacherid = scanner.nextInt();
			classDao.create(id, name, section, teacherid);
